...
const LOCATIONS_URL = 'https://raw.githubusercontent.com/optimizely/linksf/master/core/sf_location.json'
  ...
  return fetchLocations()
    .then(locations => {
      locations.forEach((location, index) => {
        location.services.forEach((service, index) => {
          taxonomies.push(service.taxonomy_ids);
      });
    });
    return R.uniq(taxonomies);
  });
}
